...
const addCopyButtons = (clipboard) => {
  ...
  document.querySelectorAll('pre > code').forEach((codeBlock) => {
    ...
    button.setAttribute('aria-label', 'copiar para área de transferência')
    button.type = 'button'
...
function initIndex() {
  ...
  index.add(
      ...
      
      {
        ...
        content: "Bootstrap framework Build fast, responsive sites with Bootstrap 5. Easily customize your site with the source Sass files. Full text search Search your site with FlexSearch, a full-text search library with zero dependencies. Development tools Use Node Package Manager to automate the build process and to keep track of dependencies. Additional features include:\nSwitching between light mode and dark mode Support for multiple languages Reusable Bootstrap components through configurable shortcodes and partials Versioned documentation, including sidebar navigation and version switcher Responsive image handling for multiple screen sizes and resolutions"
      })
      .add(
